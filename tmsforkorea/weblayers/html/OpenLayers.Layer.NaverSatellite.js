...
OpenLayers.Layer.NaverSatellite = OpenLayers.Class(OpenLayers.Layer.XYZ, {
    ...
    url: [
    "http://onetile1.map.naver.net/get/194/0/1/${z}/${x}/${y}/bl_st_bg",
    "http://onetile2.map.naver.net/get/194/0/1/${z}/${x}/${y}/bl_st_bg",
    "http://onetile3.map.naver.net/get/194/0/1/${z}/${x}/${y}/bl_st_bg",
    "http://onetile4.map.naver.net/get/194/0/1/${z}/${x}/${y}/bl_st_bg"
    ],
