...
OpenLayers.Layer.NaverHybrid = OpenLayers.Class(OpenLayers.Layer.XYZ, {
    ...
    name: "NaverHybridMap",
    url: [
    "http://onetile1.map.naver.net/get/194/0/0/${z}/${x}/${y}/empty/ol_st_rd/ol_st_an",
    "http://onetile2.map.naver.net/get/194/0/0/${z}/${x}/${y}/empty/ol_st_rd/ol_st_an",
    "http://onetile3.map.naver.net/get/194/0/0/${z}/${x}/${y}/empty/ol_st_rd/ol_st_an",
    "http://onetile4.map.naver.net/get/194/0/0/${z}/${x}/${y}/empty/ol_st_rd/ol_st_an"
    ],
