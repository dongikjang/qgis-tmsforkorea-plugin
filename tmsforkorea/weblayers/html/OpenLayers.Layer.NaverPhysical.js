...
OpenLayers.Layer.NaverPhysical = OpenLayers.Class(OpenLayers.Layer.XYZ, {
    ...
    url: [
    "http://onetile1.map.naver.net/get/194/0/0/${z}/${x}/${y}/bl_tn_bg/ol_vc_bg/ol_vc_an",
    "http://onetile2.map.naver.net/get/194/0/0/${z}/${x}/${y}/bl_tn_bg/ol_vc_bg/ol_vc_an",
    "http://onetile3.map.naver.net/get/194/0/0/${z}/${x}/${y}/bl_tn_bg/ol_vc_bg/ol_vc_an",
    "http://onetile4.map.naver.net/get/194/0/0/${z}/${x}/${y}/bl_tn_bg/ol_vc_bg/ol_vc_an"
    ],
