...
OpenLayers.Layer.NaverCadstral = OpenLayers.Class(OpenLayers.Layer.XYZ, {
    ...
    url: [
    "http://onetile1.map.naver.net/get/194/0/0/${z}/${x}/${y}/empty/ol_lp_cn",
    "http://onetile2.map.naver.net/get/194/0/0/${z}/${x}/${y}/empty/ol_lp_cn",
    "http://onetile3.map.naver.net/get/194/0/0/${z}/${x}/${y}/empty/ol_lp_cn",
    "http://onetile4.map.naver.net/get/194/0/0/${z}/${x}/${y}/empty/ol_lp_cn"
    ],
