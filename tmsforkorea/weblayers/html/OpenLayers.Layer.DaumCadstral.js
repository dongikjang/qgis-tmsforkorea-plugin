...
OpenLayers.Layer.DaumCadstral = OpenLayers.Class(OpenLayers.Layer.XYZ, {
    ...
    url: [
    "http://map0.daumcdn.net/map_usedistrict/1806shn/L${z}/${y}/${x}.png",
    "http://map1.daumcdn.net/map_usedistrict/1806shn/L${z}/${y}/${x}.png",
    "http://map2.daumcdn.net/map_usedistrict/1806shn/L${z}/${y}/${x}.png",
    "http://map3.daumcdn.net/map_usedistrict/1806shn/L${z}/${y}/${x}.png"
    ],
